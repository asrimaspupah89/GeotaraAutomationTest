...
public class LihatMerchant {
    ...
    public void user_click_on(String string) {
        driver.findElement(By.xpath("//a[text()='Merchant & Souveniers' and contains(@class, 'block')]")).click();
    }
    @Then("user should be able to see merchant and souvenier page")
    public void user_should_be_able_to_see_merchant_and_souvenier_page() {
        // Get the current URL of the page
        String actualUrl = driver.getCurrentUrl();

        // Define the expected URL of the page
        String expectedUrl = "https://portal.geotara.my.id/merchant-sourvenir";
    ...
    public void user_should_be_able_to_see_card_sort_by_alphabetically_a_z_on_page_about_merchant_and_souveniers() {
        // Get the current URL of the page
        String actualUrl = driver.getCurrentUrl();

        // Define the expected URL of the page
        String expectedUrl = "https://portal.geotara.my.id/merchant-sourvenir?filter=A-Z";
    ...
    public void user_should_be_able_to_see_card_sort_by_alphabetically_z_a_on_page_about_merchant_and_souveniers() {
        // Get the current URL of the page
        String actualUrl = driver.getCurrentUrl();

        // Define the expected URL of the page
        String expectedUrl = "https://portal.geotara.my.id/merchant-sourvenir?filter=Z-A";
    ...
    public void user_should_be_able_to_see_card_sort_by_price_low_to_high_on_page_about_merchant_and_souveniers() {
        // Get the current URL of the page
        String actualUrl = driver.getCurrentUrl();

        // Define the expected URL of the page
        String expectedUrl = "https://portal.geotara.my.id/merchant-sourvenir?filter=Low-High";
